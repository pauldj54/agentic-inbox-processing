...
- [ ] T004 Record dependency impact and justify any new external packages
...
- [ ] T006 [P] Implement authentication/authorization framework with Entra ID as default
- [ ] T007 [P] Setup API routing and middleware structure
- [ ] T008 Create base models/entities that all stories depend on
- [ ] T009 Configure error handling and structured logging infrastructure
...
- [ ] T018 [US1] Add structured logging for user story 1 operations (avoid verbose prints)
- [ ] T019 [US1] Validate responsive behavior for modified UI surfaces (if applicable)
