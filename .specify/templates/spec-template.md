...
- **CAR-003 (Responsive Design)**: Any UI surfaces MUST remain usable on common desktop and mobile
  viewport sizes.
- **CAR-004 (Dependencies)**: New dependencies MUST be explicitly justified; existing or standard
  capabilities are preferred when sufficient.
