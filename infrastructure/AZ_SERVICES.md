...
| 5 | **Azure Service Bus Namespace** | Asynchronous message broker with five queues: `email-intake`, `classification-pending`, `human-review`, `archival-pending`, `processing-complete`. Provides dead-letter support and decouples intake from AI processing. | **Standard** |
